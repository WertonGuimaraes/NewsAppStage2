...
public class SettingsPrefActivity extends AppCompatPreferenceActivity {
    ...
    public static class MainPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference(getString(R.string.key_subject_name)));
            bindPreferenceSummaryToValue(findPreference(getString(R.string.key_order_by)));
            bindPreferenceSummaryToValue(findPreference(getString(R.string.key_page_size)));
        }
    }
